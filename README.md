...
# Or manually
git clone https://github.com/jilombmiker-alt/lobe-skills.git ~/skills/follow-builders
cd ~/skills/follow-builders/scripts && npm install
```

### Claude Code
```bash
git clone https://github.com/jilombmiker-alt/lobe-skills.git ~/.claude/skills/follow-builders
